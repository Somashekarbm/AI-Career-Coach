...
//     <h1 className="text-lg text-gray-600 dark:text-gray-400 font-inter">Smart career tools, powered by AI</h1>
...
//     <p className="mt-6 text-base text-gray-500 dark:text-gray-400">60-day free trial. No credit card required.</p>
...
const Hero = ({ showGetStarted = false }) => {
    ...
    <section className="pt-12 sm:pt-16 px-4 bg-gray-50 dark:bg-black text-gray-900 dark:text-white">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <button
            onClick={handleClick}
            className={`inline-flex items-center px-8 py-3 text-lg font-bold text-white bg-gray-900 rounded-xl hover:bg-gray-700 transition ${!showGetStarted && "showen"}`}
          >
            {showGetStarted ? "Get Started" : "Create Goal"}
          </button>
